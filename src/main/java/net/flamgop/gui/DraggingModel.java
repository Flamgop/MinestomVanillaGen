...
public class DraggingModel extends MouseMotionAdapter {
    ...
    public DraggingModel(ChartPanel chartPanel, XYSeries series) {
    ...
    void adjustEntityPositionToMouse(int x, int y) {
        ...
        MainWindow.xSetContinental[selectedIndex] = range.getLowerBound() + mx * range.getLength();
        MainWindow.ySetContinental[selectedIndex] = domain.getLowerBound() + my * domain.getLength();

        Arrays.sort(MainWindow.xSetContinental);
        Arrays.sort(MainWindow.ySetContinental);
