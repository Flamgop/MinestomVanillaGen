...
public class DraggingModel2 extends MouseMotionAdapter {
    ...
    public DraggingModel2(ChartPanel chartPanel, XYSeries series) {
    ...
    void adjustEntityPositionToMouse(int x, int y) {
        ...
        MainWindow.xSetPV[selectedIndex] = range.getLowerBound() + mx * range.getLength();
        MainWindow.ySetPV[selectedIndex] = domain.getLowerBound() + my * domain.getLength();

        Arrays.sort(MainWindow.xSetPV);
        Arrays.sort(MainWindow.ySetPV);
